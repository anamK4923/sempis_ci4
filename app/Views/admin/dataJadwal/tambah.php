    ...
    <div class="col-sm-12 col-xl-10">
        <div class="bg-secondary rounded h-100 p-4">
            ...
            <form action="/jadwal/simpan" method="post">
                ...
                <div class="form-floating mb-3">
                    <input type="time" class="form-control" id="jam_mulai" placeholder="Jam Dimulai" name="jam_mulai" autofocus>
                    <label for="floatingInput">Jam Dimulai</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="time" class="form-control" id="jam_selesai" placeholder="Jam Selesai" name="jam_selesai" autofocus>
